...
<template>
  ...
  <Toast />
  <div
    class="dark:bg-surface-950 flex items-center justify-center min-w-[100vw] overflow-hidden mt-20"
  >
      ...
      >
        ...
        >
          <div class="text-center mb-8">
            <div class="dark:text-surface-0 text-2xl text-primary font-medium mb-4">
              Welcome to Botique
            </div>
            <span class="text-muted-color font-medium">{{
              loginForm ? `Đăng nhập để tiếp tục!` : `Đăng ký tài khoản`
            }}</span>
          </div>
          ...
          <div v-if="loginForm">
            <label
              for="email1"
              class="block text-surface-900 dark:text-surface-0 text-base font-medium mb-2"
              >Email</label
            >
            <InputText
              id="email1"
            ...
            <label
              for="password1"
              class="block text-surface-900 dark:text-surface-0 font-medium text-base mb-2"
              >Mật khẩu</label
            >
            <Password
              id="password1"
