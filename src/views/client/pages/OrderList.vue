<template>
  <div class="h-auto container mx-auto">
          ...
          <div class="grid grid-cols-12">
            <div class="col-span-3 flex flex-col gap-3 items-center">
              ...
              <input
                ...
                @change="UploadFileLocal($event, 0)"
              />
            </div>
    ...
    <Dialog
      v-model:visible="updateUserModal"
      modal
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-col gap-2">
          ...
          <Select
            ...
            fluid
            :options="Province"
            :placeholder="userDetail.province ? userDetail.province : ''"
        ...
        <div class="flex justify-between gap-2">
          <div class="flex flex-col gap-2 w-full">
            ...
            <Select
              ...
              fluid
              :options="Districts"
              :placeholder="userDetail.district ? userDetail.district : ''"
          ...
          <div class="flex flex-col gap-2 w-full">
            ...
            <Select
              filter
              v-model="userDetail.ward"
              :options="Wards"
              option-value="FullName"
              :placeholder="userDetail.ward ? userDetail.ward : ''"
              option-label="FullName"
              fluid
            ></Select>
          </div>
